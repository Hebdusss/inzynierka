  ...
  return (
    <div className='flex-1 min-w-0'>
        ...
        <div className='relative mb-4'>
            ...
            <input type="text" placeholder="Search diets..." value={search} onChange={handleSearch} 
        ...
        <div className='max-h-[500px] overflow-auto space-y-3 pr-1'>
            ...
            <div className='flex flex-col items-center justify-center py-12 text-center'>
                ...
                <p className='text-sm text-slate-500'>No diets yet</p>
                <p className='text-xs text-slate-400 mt-1'>Add your first diet to get started</p>
            </div>}
        </div>
    </div>
  )
